...
{
    /// <inheritdoc />
    public partial class AddQRCodeStatistics : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QRCodeStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QRCodeStatistics_QRCodes_QRCodeId",
                        column: x => x.QRCodeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QRCodeStatistics_QRCodeId",
                table: "QRCodeStatistics",
                column: "QRCodeId");
        }
